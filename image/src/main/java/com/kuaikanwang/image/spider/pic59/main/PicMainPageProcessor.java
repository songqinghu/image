package com.kuaikanwang.image.spider.pic59.main;
...
@Component("picMainPageProcessor")
public class PicMainPageProcessor implements PageProcessor,WebSiteIdentification{
    ...
    public void process(Page page) {
        ...
        List<String> all = page.getHtml().
        		...
        		links().
        		regex("http://www\\.59pic\\.com/.+/\\d+_\\d+\\.html").all();
