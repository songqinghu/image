package com.kuaikanwang.image.spider.gif.process.manhaoxiao.main;
...
@Component("manhaoxiaoMainPageProcessor")
public class ManHaoXiaoMainPageProcessor implements PageProcessor,WebSiteIdentification{
