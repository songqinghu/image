package com.kuaikanwang.image.spider.gif.process.manhaoxiao.pre;
...
@Component("manhaoxiaoPrePageProcessor")
public class ManHaoXiaoPrePageProcessor implements PageProcessor,WebSiteIdentification{
