package com.kuaikanwang.image.spider.gif.process.kx1d.main;
...
@Component("kx1dMainPageProcessor")
public class KX1DMainPageProcessor implements PageProcessor,WebSiteIdentification {
