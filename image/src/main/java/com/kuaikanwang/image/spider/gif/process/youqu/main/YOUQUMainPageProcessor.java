package com.kuaikanwang.image.spider.gif.process.youqu.main;
...
@Component("youquMainPageProcessor")
public class YOUQUMainPageProcessor implements PageProcessor,WebSiteIdentification{
