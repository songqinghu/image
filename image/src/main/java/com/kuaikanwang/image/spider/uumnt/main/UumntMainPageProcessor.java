package com.kuaikanwang.image.spider.uumnt.main;
...
@Component("uumntMainPageProcessor")
public class UumntMainPageProcessor implements PageProcessor,WebSiteIdentification{
