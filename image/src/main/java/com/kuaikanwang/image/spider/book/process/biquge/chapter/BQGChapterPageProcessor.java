package com.kuaikanwang.image.spider.book.process.biquge.chapter;
 ...
 * @version 1.0
 */
@Component("BQGChapterPageProcessor")
public class BQGChapterPageProcessor implements PageProcessor,WebSiteIdentification {
