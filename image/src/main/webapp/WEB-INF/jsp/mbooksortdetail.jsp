...
<html lang="zh-CN">
  <head>
    ...
    <!-- 上述3个meta标签*必须*放在最前面，任何其他内容都*必须*跟随其后！ -->
            ...
            <title>修真小说 好看的修真小说_2015修真小说排行榜_最愉阅移动版</title>
		<meta name="keywords" content="最愉阅小说,修真小说,小说阅读网,小说" />
		<meta name="description" content="最愉阅小说是广大书友最值得收藏的修真小说阅读网，网站收录了当前最火热的修真小说，免费提供高质量的小说最新章节，是广大网络小说爱好者必备的小说阅读网。" />
   <!-- Bootstrap -->
...
<div class="toptab">
	<span class="active">${bookType.bookTypeName}榜</span>
</div>
...
<div class="bookbox">
  ...
  <ul class="pagination">
    <li>
      <a href="/m/book/type/${bookType.bookTypeId}/1" aria-label="Previous">
        <span aria-hidden="true">首页</span>
             ...
             <c:choose>
    			<c:when test="${nowPage == page}">
     				<li class="active"><a href='/m/book/type/${bookType.bookTypeId}/${nowPage}'>${nowPage}</a></li>
    			</c:when>
   				 <c:otherwise>
        			<li><a href='/m/book/type/${bookType.bookTypeId}/${page}'>${page}</a></li>
   			 	</c:otherwise>
			</c:choose>
	 		 </c:forEach>
      	    <c:if test="${nowPage < maxPage}">
  				<li> <a href='/m/book/type/${bookType.bookTypeId}/${nowPage + 1}'>下一页</a></li>
			</c:if>
  </ul>
  </body>
