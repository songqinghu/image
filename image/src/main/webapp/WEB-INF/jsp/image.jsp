...
<html lang="zh-CN">
  <head>
    ...
    <title>${nowImageType.typeName}_性感图片_${nowImageType.typeName}美女套图 - 快看网-美女图片</title>
      ...
      <dl class="list_hot public-box">
         ...
         <!-- 动态生成 -->
            <c:forEach var="image"  items="${countPicList}">
         	        <dd><a target="_blank" href="http://www.kuaikanwang.com/images/detail?pid=${image.pid}">${image.picName}</a></dd>
	  	     </c:forEach>
