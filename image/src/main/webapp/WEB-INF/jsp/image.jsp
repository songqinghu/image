...
<div class="main">
   <dl class="list-left public-box">
   	  <!-- 这里应该也是动态的 -->
      <dt class="public-title">您的位置:<a href='http://www.kuaikanwang.com/'>快看网</a> > <a href='http://www.kuaikanwang.com/images/${nowImageType.imageType}/list'>${nowImageType.typeName}</a> > 图集列表</dt>
      <!-- 这里应该也是动态的获取数据 -->
