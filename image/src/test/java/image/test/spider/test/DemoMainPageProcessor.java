...
//                .regex("src=\"\\s*((http://)?.+\\.(jpg|gif|png))\\s*\"")
        ...
        if( urls == null || urls.size()==0){
            urls = page.getHtml().
                    xpath("//div[@class='container']/div/div[@class='NEWS']/div/div/p/img")
                    .regex("src=\"\\s*((http://)?.+\\.(jpg|gif|png))\\s*\"")
                    //.links()
                    .all();
        }
...
//        }
        ...
        List<String> names = page.getHtml()
                .xpath("//div[@class='container']/div/div[@class='NEWS']/div/h1/text()")
                .regex("\\S+")
                .all();
        ...
        List<String> all = page.getHtml().
                xpath("//div[@class='container']/div/div[@class='NEWS']/div/div[@class='itempage']/a").
                links()
                .regex("http://www.7160.com/.+_\\d+\\.html")
                .all();
